/**
 * Template copy — the words that stay the same across every demo.
 * Firm-specific words live in `firm.ts`; this file only assembles them.
 *
...
import { buckets, meta, reconcile } from './story';
...
export const hero = {
  ...
  headline: `${firm.discipline} for ${firm.audience.clientType} in ${firm.audience.homeState}.`,
